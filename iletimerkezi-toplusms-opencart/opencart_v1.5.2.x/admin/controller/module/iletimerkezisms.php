...
class ControllerModuleIletimerkezisms extends Controller {
	...
	public function index() {
        ...
        if(empty($iletimerkezisms_username)||empty($iletimerkezisms_password)) {
        	...
        	$setdomain = $sms->setDomain($iletimerkezisms_username, $iletimerkezisms_passwordß);
        }
		...
		$this->data['action'] = $this->url->link('module/iletimerkezisms', 'token=' . $this->session->data['token'], 'SSL');
