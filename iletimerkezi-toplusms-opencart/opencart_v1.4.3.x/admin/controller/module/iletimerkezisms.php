...
class ControllerModuleIletimerkezisms extends Controller {
	...
	public function index() {
        ...
        if(empty($iletimerkezisms_username)||empty($iletimerkezisms_password)) {
        	...
        	$setdomain = $sms->setDomain($iletimerkezisms_username,$iletimerkezi_password);
        }
		...
		if (isset($this->error['dimension'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => HTTPS_SERVER . 'index.php?route=common/module',
      		'separator' => ' :: '
   		);

   		$this->data['breadcrumbs'][] = array(
       		'text'      => $this->language->get('heading_title'),
			'href'      => HTTPS_SERVER . 'index.php?route=common/iletimerkezisms',
      		'separator' => ' :: '
   		);

		$this->data['action'] = HTTPS_SERVER . 'index.php?route=module/iletimerkezisms';
