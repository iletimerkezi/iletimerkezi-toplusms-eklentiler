  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        ...
        <tr>
            <td><span class="required">*</span>Başlık Bilginiz:
              <br>
              <span class="help">
        ...
        <tr>
          ...
          <td><textarea rows="8" cols="120" name="message" id="message"><?php echo $message; ?></textarea>
...
function getCustomers() {
	...
	$.ajax({
		url: 'index.php?route=sale/sms/customer&keyword=' + encodeURIComponent($('#search').attr('value')),
		dataType: 'json',
