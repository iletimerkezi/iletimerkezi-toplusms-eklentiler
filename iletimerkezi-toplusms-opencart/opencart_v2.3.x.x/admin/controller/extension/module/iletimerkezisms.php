...
class ControllerExtensionModuleIletimerkezisms extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/iletimerkezisms', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		if (isset($this->error['dimension'])) {
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/iletimerkezisms', 'token=' . $this->session->data['token'], 'SSL'),
   		);

		$data['action'] = $this->url->link('extension/module/iletimerkezisms', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->template = 'extension/module/iletimerkezisms.tpl';
		$data['header'] = $this->load->controller('common/header');
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');

		$this->response->setOutput($this->load->view('extension/module/iletimerkezisms.tpl', $data));
	}
