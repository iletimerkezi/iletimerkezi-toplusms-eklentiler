<div class="panel">
    ...
    <div class="panel">
      <div class="alert alert-info">
        ...
        - <strong>%kargoadı%</strong> - Kargo İsmi<br />
        <br />
            ...
            <tbody>
              ...
              <tr class="odd">
                <td class="">{$text_iletimerkezi_tracking_number} :
                  <p class="help-block">
                    (Mesajin içinde %orderid% %orderreference% %firstname% %lastname% %telephone% %trackingnumber% %kargoadı% %url% degiskenini kullanabilirsiniz.)
                  </p>
                </td>
                <td class="">
