    ...
    <div class="panel-body">      
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form-group">
          <tr class="form-group">
            <td class="form-group"><span style="color:red;">Mevcut Bakiyeniz</span></td>
            <td>
          ...
          <tr class="form-group">
            <td class="form-group">iletimerkezi.com telefon numaranız:
              <br>
          ...
          <tr class="form-group">
            <td class="form-group">iletimerkezi.com şifreniz:</td>
            <td>
              <?php
          ...
          <tr class="form-group">
            <td class="form-group">Başlık Bilginiz:
              <br>
              <span class="help">
          ...
          <tr class="form-group">
            <td class="form-group">Yeni üyeye, kullanıcı adı ve şifresi sms olarak gönderilsin:
              <br>
              <span class="help">
          ...
          <tr class="form-group">
            <td class="form-group">Üyelik onayı olunca mesaj gitsin :
              <br>
              <span class="help">
                <br>Kullanabileceğiniz değişkenler<br>
                %firstname%<br>
            ...
            <td>
              <?php
              if(!empty($iletimerkezisms['iletimerkezisms_sms_approved_text'])) {
                $iletimerkezisms_sms_approved_text = $iletimerkezisms['iletimerkezisms_sms_approved_text'];
              } else {
                $iletimerkezisms_sms_approved_text = '';
              }
              ?>
              <textarea rows="10" cols="60" name="iletimerkezisms_sms_approved_text"><?php echo $iletimerkezisms_sms_approved_text; ?></textarea>
