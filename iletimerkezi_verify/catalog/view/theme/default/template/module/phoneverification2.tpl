...
Aşağıdaki alana erişebileceğiniz telefon numarası yazınız, telefon numaranıza gelen şifreyi girmeniz istenecektir.
				<br><br>
				Telefon numaranız:
...
Aşağıdaki alana cep telefonunuza gelen doğrulama şifrenizi giriniz.
<br>
<br>
Pin: <input type="text" name="pin" id="pin">
  <div class="right"> <a id="button-confirm" class="button"><span>Doğrula</span></a> <a id="button-startver2" class="button"><span>Tekrar Gönder</span></a></div>
</div>
